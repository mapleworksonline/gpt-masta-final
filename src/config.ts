...
export const config: IConfig = {
	...
	gptPrefix: process.env.GPT_PREFIX || "", // Default: ""
	dallePrefix: getDallePrefix(), // Default: image
	...
	whatsappBotToken: process.env.WHATSAPP_TOKEN || "", // Default: null
	whatsappId: process.env.WHATSAPP_ID || "", // Default: null
	whatsappWebhookToken: process.env.WEBHOOK_TOKEN || "",
	dallePrePrompt: process.env.DALLE_PRE_PROMPT || ""
};

function getDallePrefix(): string[]{
	const envValue = process.env.DALLE_PREFIX;
